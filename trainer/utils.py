...
class AdaptiveKLController:
    ...
    https://arxiv.org/pdf/1909.08593.pdf  论文第三页右边的公式.但是论文只是提到这个公式,并没有解释原因.
    """
    ...
    def update(self, current, n_steps):
        ...
        self.value *= mult  # kl的系数一直跟steps进行跟新.
...
#========这个函数进行对于examples进行编码
    def torch_call(self, examples: List[Union[List[int], Any, Dict[str, Any]]]) -> Dict[str, Any]:
        ...
        for i in range(len(examples)):
            ...
            #============找到template的开始索引.response_token_ids_start_idx
            ...
            #=====然后template部分都设置为ignore. 不计算梯度即可.
